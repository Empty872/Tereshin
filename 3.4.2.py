...
class Report:
    ...
    def generate_excel(self):
        ...
        excelSheetFirst['C1'] = f'Средняя зарплата - {self.inputValues.professionName}'
        excelSheetFirst['D1'] = 'Количество вакансий'
        excelSheetFirst['E1'] = f'Количество вакансий - {self.inputValues.professionName}'
    ...
    def generate_pdf(self):
        ...
        pdfkit.from_string(pdf_template, 'report_3_4_2.pdf', configuration=config,
